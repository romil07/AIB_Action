    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (Utils_2.default.IsEqual(JSON.parse(`${outStream}`) && JSON.parse(`${outStream}`).properties.state, "Registered")) {
                ...
                if (Utils_2.default.IsEqual(JSON.parse(`${outStream}`) && JSON.parse(`${outStream}`).registrationState, "Registered")) {
